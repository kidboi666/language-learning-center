...
import me.leejinwook.springbootkotlin.core.response.ErrorResponse
...
class CustomExceptionHandler {
    ...
    protected fun invalidInputExceptions(ex: InvalidInputException): ResponseEntity<ErrorResponse> {
